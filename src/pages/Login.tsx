...
const Login = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // La logique d'authentification sera ajoutée ultérieurement
  };
          ...
          <Card className="p-6">
            <div className="text-center mb-6">
              ...
              <p className="text-muted-foreground mt-2">
                Accédez à votre compte TokponlaEngagé
              </p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {/* Bouton Google avec redirection */}
                <Button variant="outline" type="button" className="flex items-center justify-center gap-2">
                  <a href="https://accounts.google.com/o/oauth2/v2/auth" target="_blank" rel="noopener noreferrer">
                ...
                {/* Bouton Facebook avec redirection */}
                <Button variant="outline" type="button" className="flex items-center justify-center gap-2">
                  <a href="https://www.facebook.com/v9.0/dialog/oauth" target="_blank" rel="noopener noreferrer">
